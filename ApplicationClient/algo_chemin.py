...
def dijkstra(graphe: dict, depart: str, bk_liste: list = []) -> dict:
    """
    Renvoie un dictionnaire avec pour chaque sommet accessible depuis 'depart' :
    la distance minimale depuis 'depart'
    le chemin emprunté (sous forme de liste de sommets)
    :param graphe: dict des voisins {sommet: {voisin: distance, ...}, ...}
    :param depart: sommet de départ
    :param bk_liste: liste de sommets à éviter,vide par défaut
    """
